    ...
    <div className="chat">
      <header className="chat__header">
        <div className="chat__title">
          ...
          <span className="chat__subtitle">Especializado en melocotón/durazno</span>
        </div>
        ...
        {msgs.map((m, idx) => (
          ...
          >
            ...
            <div className="chat__text">
              {/* Render simple de markdown básico (solo saltos de línea) */}
              {m.text.split("\n").map((line, i) => (
                <p key={i}>{line}</p>
              ))}
            </div>
      ...
      <footer className="chat__composer">
        <textarea
          ...
          rows={2}
        />
        <button className="chat__btn" onClick={send} disabled={!canSend || busy}>
